<?php
    ...
    $key = 'AIzaSyA7Jhj5_7V-JArXlCLm4zrfcGw-KNZEpW4';
    ...
    function save($post)
    {
        ...
        $query = "INSERT INTO salesleads (id, name, phone, email, zipcode, best, make, model, engine, date)
                    VALUES(
                        '', 
                        '".$post['name']."', 
                        '".$post['phone']."', 
    ...
    {
        $key = 'AIzaSyAF_TmBr8klcdodiGAGZKN0lpgRqDLknc4';
